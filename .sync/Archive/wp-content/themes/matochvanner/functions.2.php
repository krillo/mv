...
function spring_enqueue_scripts() {
  ...
  wp_enqueue_style('spring.print', get_stylesheet_directory_uri() . '/css/matochvanner.print.css', array(), '2014-11-19', 'print');
}
